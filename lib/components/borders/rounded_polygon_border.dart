...
class RoundedPolygonBorder extends OutlinedBorder {
  ...
  @override
  RoundedPolygonBorder copyWith({ BorderSide? side, BorderRadiusGeometry? borderRadius }) {
    return RoundedPolygonBorder(
      side: side ?? this.side,
...
class _RoundedPolygonToCircleBorder extends OutlinedBorder {
  ...
  @override
  _RoundedPolygonToCircleBorder copyWith({ BorderSide? side, BorderRadiusGeometry? borderRadius, double? circleness }) {
    return _RoundedPolygonToCircleBorder(
      side: side ?? this.side,
      borderRadius: borderRadius ?? this.borderRadius,
